...
//IPAddress ip(192,168,76,3);
//byte mac[] = { 0x90, 0xA2, 0xDA, 0x10, 0xA1, 0xC3 };
//IPAddress ip(192,168,76,4);

// Work AccuTest Board stats
            ...
            {   // client data available to read
                ...
                if (c == '\n' && currentLineIsBlank)
                {
                    ...
                    {  // HTTP request for web page
                        ...
                        client.println("<h1>Meter Pulse Data (1-2)</h1>");
                        
                        /****************************************/
//                        client.print("<h2>MAC Address: ");
//                        for (byte i = 0; i < sizeof(mac); i++)
//                        {
