...
unsigned long pulse3CountA, pulse3CountB, pulse3Error;
int pulse3State;
unsigned int pulse3Srate, pulse3Freq, pulse3MaxFreq;
unsigned long pulse3AdjustWaitTime, pulse3AdjustTimeout;
int pulse3OutFunctionReq, pulse3OutFunction, pulse3LastRise;
unsigned int pulse3OCRA, pulse3ValveType;
...
unsigned long pulse4CountA, pulse4CountB, pulse4Error;
int pulse4State;
unsigned int pulse4Srate, pulse4Freq, pulse4MaxFreq;
unsigned long pulse4AdjustWaitTime, pulse4AdjustTimeout;
int pulse4OutFunctionReq, pulse4OutFunction, pulse4LastRise;
unsigned int pulse4OCRA, pulse4ValveType;
...
{
  unsigned int _ad_counts, ocr, _int_freq;
  unsigned char _adcl, _adch;
  float _float_freq;
  int i = 0;
            ...
            {   // client data available to read
                ...
                if (c == '\n' && currentLineIsBlank)
                {
                    ...
                    {  // HTTP request for web page
                       ...
                       client.println("<form action=\"\" method=\"get\">"); 
                       client.println("<button type=\"button\" value=\"E4\" onclick=\"pulseSelect3(this.value)\">A->B Leak</button><br>");
                       client.println("<button type=\"button\" value=\"F5\" onclick=\"pulseSelect3(this.value)\">B->A Leak</button><br>");
                       client.println("<button type=\"button\" value=\"A0\" onclick=\"pulseSelect3(this.value)\">Stop Leak</button><br>");
                       ...
                       client.println("<form action=\"\" method=\"get\">"); 
                       client.println("<button type=\"button\" value=\"E4\" onclick=\"pulseSelect4(this.value)\">A->B Leak</button><br>");
                       client.println("<button type=\"button\" value=\"F5\" onclick=\"pulseSelect4(this.value)\">B->A Leak</button><br>");
                       client.println("<button type=\"button\" value=\"A0\" onclick=\"pulseSelect4(this.value)\">Stop Leak</button><br>");
