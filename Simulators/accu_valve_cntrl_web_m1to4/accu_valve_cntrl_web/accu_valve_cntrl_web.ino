...
byte mac[] = { 0x90, 0xA2, 0xDA, 0x10, 0x82, 0xDB };//byte mac[] = { 0x90, 0xA2, 0xDA, 0x00, 0xCC, 0xBA };
//byte ip[] = (192, 168, 180, 84); // IP address, may need to change depending on network (ip(10, 0, 0, 20);)
